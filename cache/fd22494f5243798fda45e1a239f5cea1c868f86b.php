<?php if(isset($_SESSION['error_message'])): ?>
    <div class="alert alert-danger alert-dismissible fade show mx-3 mt-2" role="alert" id="errorAlert">
        <i class="bi bi-exclamation-triangle me-2"></i><?php echo e($_SESSION['error_message']); ?>
...
<?php if(isset($_SESSION['success_message'])): ?>
    <div class="alert alert-success alert-dismissible fade show mx-3 mt-2" role="alert" id="successAlert">
        <i class="bi bi-check-circle me-2"></i><?php echo e($_SESSION['success_message']); ?>
                                ...
                                <div class="dropdown">
                                    <a href="#" class="d-flex align-items-center user-dropdown-link text-decoration-none" 
                                       id="userDropdown" data-bs-toggle="dropdown" aria-expanded="false" style="outline: none;">
                                        ...
                                        <small class="text-white-50 ms-1">(<?php echo e($_SESSION['user_role']); ?>)</small>
                                    </a>
                ...
                <nav class="navbar navbar-expand-lg custom-navbar">
                    <div class="container px-0">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(($activePage == 'home') ? 'active' : ''); ?>" href="/">LỊCH CHIẾU</a>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link <?php echo e(($activePage == 'movies') ? 'active' : ''); ?>" href="#" id="phimDropdown"
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(($activePage == 'offers') ? 'active' : ''); ?>" href="/uu-dai">ƯU ĐÃI</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(($activePage == 'member') ? 'active' : ''); ?>" href="/thanh-vien">THÀNH VIÊN</a>
                            </li>
                            </ul>
                        </div>
                    </div>
...
</script><?php /**PATH D:\Server\ct27501-project-BanhNhatKhang\app\Views/layouts/users/Header.blade.php ENDPATH**/ ?>