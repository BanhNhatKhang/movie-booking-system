<header>
                ...
                <div class="col">
                    ...
                    <div class="container px-0">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(($activePage == 'offers') ? 'active' : ''); ?>" href="/static/html/users/UuDai/UuDai.php">ƯU ĐÃI</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(($activePage == 'member') ? 'active' : ''); ?>" href="/static/html/users/ThanhVien/ThanhVienKHF.php">THÀNH VIÊN</a>
                            </li>
                            </ul>
                        </div>
                    </div>
    ...
    </header><?php /**PATH C:\mysites\ct27501-project-BanhNhatKhang-1\app\Views/layouts/users/Header.blade.php ENDPATH**/ ?>