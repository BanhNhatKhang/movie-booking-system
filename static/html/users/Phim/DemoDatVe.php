...
<head>
    ...
    <link rel="stylesheet" href="/static/css/users/DemoDatVeDangChieu.css">
                        ...
                        <div class="row bg-light-subtle border rounded text-dark p-3 me-3 align-items-start">
                            <div class="col-lg-9 col-md-12">
                                <div >
                                    ...
                                    <div>
                                        <p>
                                            <span class="fw-semibold">Thể loại :</span> Tình cảm, Gia đình - Lồng tiếng
                                        </p>
