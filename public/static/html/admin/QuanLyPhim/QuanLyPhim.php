...
<div class="main-content">
    ...
    <div class="content">
        <form class="row g-3 align-items-end filter-form mb-3" method="get">
            <div class="col-md-4">
                <label class="form-label">Tìm kiếm tên phim</label>
                <input type="text" class="form-control" name="q" placeholder="Nhập tên phim..." value="<?= isset($_GET['q']) ? htmlspecialchars($_GET['q']) : '' ?>">
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-3 text-end">
                <a href="ThemPhim.php" class="btn btn-success"><i class="bi bi-plus-circle"></i> Thêm phim mới</a>
            </div>
        </form>
        <!-- Danh sách phim -->
            ...
            <table class="table align-middle table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php
                            if($movie['status']=='showing') echo '<span class="badge status-badge status-showing">Đang chiếu</span>';
                            elseif($movie['status']=='coming') echo '<span class="badge status-badge status-coming">Sắp chiếu</span>';
                            else echo '<span class="badge status-badge status-ended">Ngưng chiếu</span>';
                            ?>
                        </td>
                        <td>
                            <a href="SuaPhim.php?id=<?= $movie['id'] ?>" class="btn btn-warning btn-sm action-btn" title="Sửa"><i class="bi bi-pencil"></i></a>
...
<!-- Có thể thêm modal/thông báo ở đây nếu muốn -->
