{{-- filepath: c:\Servers\test\app\Views\admin-views\QuanLyNguoiDung\QuanLyNguoiDung.blade.php --}}
            ...
            <table class="table align-middle table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/chi-tiet-nguoi-dung?id={{ $user['id'] }}" class="btn btn-info btn-sm action-btn" title="Xem thông tin"><i class="bi bi-eye"></i></a>
                            @if($user['status']!='locked')
                            <a href="/khoa-nguoi-dung?id={{ $user['id'] }}" class="btn btn-danger btn-sm action-btn" title="Khóa tài khoản" onclick="return confirm('Bạn chắc chắn muốn khóa tài khoản này?')"><i class="bi bi-lock"></i></a>
                            @endif
                        </td>
                    </tr>
                    @empty
