<div class="collapse d-lg-block sidebar" id="mobileSidebar">
    ...
    <a class="nav-link {{ ($activePage ?? '') == 'home' ? 'active' : '' }}" href="/quan-ly-trang-chu">
        <i class="bi bi-house-door"></i> Quản lý trang chủ
    </a>
    <a class="nav-link {{ ($activePage ?? '') == 'admin-movies' ? 'active' : '' }}" href="/quan-ly-phim">
        <i class="bi bi-film"></i> Quản lý phim
    </a>
    <a class="nav-link {{ ($activePage ?? '') == 'schedule' ? 'active' : '' }}" href="/quan-ly-lich-chieu">
    ...
    <a class="nav-link {{ ($activePage ?? '') == 'book-ticket' ? 'active' : '' }}" href="/dat-ve-tai-quay">
        <i class="bi bi-ticket-perforated"></i> Đặt vé tại quầy
    </a>
    <a class="nav-link {{ ($activePage ?? '') == 'uudai' ? 'active' : '' }}" href="/quan-ly-uu-dai">
        <i class="bi bi-gift"></i> Ưu đãi
    </a>
    <a class="nav-link {{ ($activePage ?? '') == 'user' ? 'active' : '' }}" href="/quan-ly-nguoi-dung">
        <i class="bi bi-people"></i> Khách hàng
    </a>
    <a class="nav-link {{ ($activePage ?? '') == 'pay' ? 'active' : '' }}" href="/quan-ly-thanh-toan">
        <i class="bi bi-credit-card"></i> Thanh toán
    </a>
    <a class="nav-link {{ ($activePage ?? '') == 'NhanVien' ? 'active' : '' }}" href="/quan-ly-nhan-vien">
